...
const organizationTree: FilterDashboardOrg[] = [
  {
    id: 801,
    createdDate: '',
    createdBy: 'system',
    deleted: 0,
    orgName: 'Hội sở chính',
    orgCode: 'HO',
        ...
        children: [
          {
            ...
            createdBy: 'system',
            deleted: 0,
            orgName: 'Phòng Phát triển ứng dụng',
            orgCode: 'APP-DEV',
            orgLevel: 'DEPARTMENT',
            orgParentId: 802,
            status: 1,
...
export const formSelectNew = (): Array<FormItemsProps> => [
  ...
  },
  {
    ...
    value: organizationTree[0].children
      ? [organizationTree[0].children[0]]
      : [],
    error: '',
    isRequire: true,
    dataRadio: [],
    dataSelect: [],
    dataTree: organizationTree,
    disabled: false,
    searchBox: true,
  },
  {
